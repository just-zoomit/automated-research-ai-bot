    ...
    return (
        <div className="InMeeting">
            ...
            <div className="InMeeting-record">
                ...
                >
                    {recordingState === 'stopped' && 'Start Talking'}
                    {recordingState === 'recording' && 'Stop Talking'}
                    {(recordingState === 'starting' || recordingState === 'bot-joining') && 'Starting...'}
                    {(recordingState === 'stopping' || recordingState === 'bot-leaving') && 'Stopping...'}
                    {recordingState === 'waiting' && 'Waiting for permission...'}
